  ...
  render() {
    return (
      <article>
        ...
        <p>
I have a lot of experience with many market sectors such as ecommerce, health, travel, fin-tech, book publishing, mortgage comparison and more. I have led and grown front end teams and always ensure that clean, scalable solutions are delivered.</p>
