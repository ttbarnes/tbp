...
export class IconStackOverflow extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <svg viewBox="0 0 512 512" style={{ minWidth: 47, maxHeight: 80 }}>
