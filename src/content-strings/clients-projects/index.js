export const CLIENTS_PROJECTS = [
  {
    heading: 'FinTech',
    items: [
      {
        id: 'uk-export-finance',
      ...
      {
        id: 'crypto-reports-combiner',
        name: 'Crypto Reports',
        date: '2018',
        industry: 'FinTech',
        summary: 'Prototype/proof of concept',
        tech: [
          'React',
          'Redux',
          'Express, Node js',
        ...
        primaryTech: 'Full stack JS',
        highlights: [
          "From trading crypto currencies, I realised that I couldn't easily view all of my trades in one place",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        date: '2015',
        industry: 'Open source',
        tech: ['AngularJS', 'JavaScript', 'Grunt', 'Sass', 'HTML, CSS'],
        primaryTech: 'Angular',
        highlights: [
